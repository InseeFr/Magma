 ...
 * sur l'évènvement ApplicationEnvironmentPreparedEvent.
 *
 ...
 * détectés par Spring boot au démarrage (une propriété présente présente uniquement dans le code sous la forme
 ...
 *
 * Le comportement de cette classe peut être amendé par les propriété suivantes :
 ...
 *     et qui ne font pas partie des propertySource ignorés (le noms des propertysource ignorés figurent
 *     dans fr.insee.properties.log.sources.ignored))
 *   - cf enum PropertySelectorEnum
 * - fr.insee.properties.log.sources.ignored : nom des propertysource qui seront ignorées.
