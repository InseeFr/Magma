...
public class OperationBySerieIdDTO extends OperationsBySerieIdDTO implements Serializable{
     ...
     * @param uri
     */
    public OperationBySerieIdDTO(List<AltLabel> altLabel, List<Label> label, String uri, Serie serie, String id) {
        super();
    ...
    List<OperationBySerieIdDTO> operationBySerieIdDTOList;
