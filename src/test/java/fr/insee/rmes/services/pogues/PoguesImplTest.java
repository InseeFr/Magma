...
class PoguesImplTest {
    ...
    void getOperationByCodeTest() throws JsonProcessingException {
        ...
        OperationById operationById= new OperationById("serie","idoperation","operationLabelLg1","operationLabelLg2","serieLabelLg1","uri","serieId","serieLabelLg2", Collections.singletonList("proprietaire"));
