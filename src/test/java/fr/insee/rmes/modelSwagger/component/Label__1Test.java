...
import fr.insee.rmes.modelSwagger.codeList.Label__1;
...
class Label__1Test {
    ...
    fr.insee.rmes.modelSwagger.codeList.Label__1 firstLabel = new fr.insee.rmes.modelSwagger.codeList.Label__1("langue","contenu");
    fr.insee.rmes.modelSwagger.codeList.Label__1 secondLabel = new Label__1();
