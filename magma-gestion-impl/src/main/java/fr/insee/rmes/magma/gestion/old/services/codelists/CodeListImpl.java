...
import fr.insee.rmes.magma.gestion.old.services.utils.CommonMethods;
...
public class CodeListImpl extends RdfService implements CodeListsServices {
    ...
    public String getCodesList(String notation) throws RmesException {
        ...
        if(codesList.has("id")) {
            ...
            throw new RmesException(HttpStatus.NOT_FOUND,"Non existent codes list identifier", "The id " + notation + " does not correspond to any codes list");
        }
    }
