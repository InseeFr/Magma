...
//
//import fr.insee.rmes.magma.gestion.old.persistence.ontologies.EVOC;
//import fr.insee.rmes.magma.gestion.old.persistence.ontologies.INSEE;
//import fr.insee.rmes.magma.gestion.old.persistence.ontologies.QB;
...
//            throws RmesException, JSONException {
...
//	}
//
//	public RepositoryResult<Statement> getCompleteGraph(RepositoryConnection con, Resource context) throws RmesException, JSONException {
//		RepositoryResult<Statement> statements = null;
//		try {
...
//	}
//
//	public void closeStatements(RepositoryResult<Statement> statements) throws RmesException, JSONException {
//		try {
//			statements.close();
//		} catch (RepositoryException e) {
...
//	 * @throws RmesException
//	 */
//	public void loadSimpleObject(IRI object, Model model, RepositoryConnection conn) throws RmesException, JSONException {
//		try {
//			if (conn == null) {
...
//	}
//
//	public void deleteObject(IRI object, RepositoryConnection conn) throws RmesException, JSONException {
//		try {
//			if (conn == null) {
//				conn = REPOSITORY_GESTION.getConnection();
//			}
...
//	 * @throws RmesException
//	 */
//	public void replaceGraph(Resource graph, Model model, RepositoryConnection conn) throws RmesException, JSONException {
//		try {
//			if (conn == null) {
//				conn = REPOSITORY_GESTION.getConnection();
//			}
...
//	}
//
//	public void loadObjectWithReplaceLinks(IRI object, Model model) throws RmesException, JSONException {
//		try (RepositoryConnection conn = REPOSITORY_GESTION.getConnection()){
...
//    }
//
//	public void objectsValidation(List<IRI> collectionsToValidateList, Model model) throws RmesException, JSONException {
//		try {
...
//	}
//
//	public void objectValidation(IRI ressourceURI, Model model) throws RmesException, JSONException {
//		try {
//			RepositoryConnection conn = REPOSITORY_GESTION.getConnection();
...
//	}
//
//	public void clearConceptLinks(Resource concept, RepositoryConnection conn) throws RmesException, JSONException {
//		List<IRI> typeOfLink = Arrays.asList(SKOS.BROADER, SKOS.NARROWER);
//		getStatementsAndRemove(concept, conn, typeOfLink);
//	}
//
//	public void clearReplaceLinks(Resource object, RepositoryConnection conn) throws RmesException, JSONException {
...
//	}
//
//	public void clearStructureNodeAndComponents(Resource structure) throws RmesException, JSONException {
...
//	}
//
//	public void keepHierarchicalOperationLinks(Resource object, Model model) throws RmesException, JSONException {
...
//			RepositoryConnection conn) throws RmesException, JSONException {
//		for (IRI predicat : typeOfLink) {
...
//	}
//
//	private static void throwsRmesException(Exception e, String details) throws RmesException, JSONException {
//		logger.error(details);
//		logger.error(e.getMessage());
//		throw new RmesException(HttpStatus.SC_INTERNAL_SERVER_ERROR, e.getMessage(), details);
//	}
//
//	public void loadSimpleObject(IRI geoIRI, Model model) throws RmesException, JSONException {
