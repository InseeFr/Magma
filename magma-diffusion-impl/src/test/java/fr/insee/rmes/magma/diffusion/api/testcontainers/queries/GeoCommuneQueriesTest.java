...
// geo/commune/01053/intersections?date=2025-09-04
    ...
    void should_return_30_territoires_when_CommuneCodeIntersections_code01053_date20250904(){
        ...
        assertAll(
                ...
                () -> assertEquals(CommuneListeTerritoiresLiesInner.TypeEnum.DEPARTEMENT, resultItem1.getType()),
                () -> assertEquals(LocalDate.of(1967,12,31), resultItem1.getDateCreation()),
                () -> assertEquals("Ain", resultItem1.getIntituleSansArticle()),
                () -> assertEquals(CommuneListeTerritoiresLiesInner.TypeArticleEnum._5, resultItem1.getTypeArticle()),
    ...
    void should_return_2_cantons_when_CommuneCodeIntersections_code01053_date20250904_typeCanton(){
        ...
        assertAll(
                ...
                () -> assertEquals(CommuneListeTerritoiresLiesInner.TypeEnum.CANTON, resultItem1.getType()),
                ...
                () -> assertEquals(CommuneListeTerritoiresLiesInner.TypeArticleEnum._0, resultItem1.getTypeArticle()),
                ...
                () -> assertEquals(CommuneListeTerritoiresLiesInner.TypeEnum.CANTON, resultItem2.getType()),
                () -> assertEquals(LocalDate.of(2016,1,1), resultItem1.getDateCreation()),
                () -> assertEquals("Bourg-en-Bresse-2", resultItem2.getIntituleSansArticle()),
                () -> assertEquals(CommuneListeTerritoiresLiesInner.TypeArticleEnum._0, resultItem2.getTypeArticle()),
