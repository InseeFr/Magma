...
import fr.insee.rmes.magma.diffusion.api.GeoRegionEndpoints;
...
//   geo/region/06/descendants?date=2025-09-04 : renvoie 209 territoires
    @Test
    void should_return_210_territoires_when_RegionCodeDescendants_code06_date20250904_typeNull_filtreNomNull(){
        var response  = endpoints.getcogregdes("06", LocalDate.of(2025, 9, 4), null, null);
        var result = response.getBody();
        assertNotNull(result);
        var resultItem1= result.getFirst();
        assertAll(
                () -> assertEquals(210, result.size()),
